...
- 文末の「。」は基本使わない（Xの口語体では句点を省くのが自然。体言止め・余韻・疑問で切る）
...
A. 一行気づき（短くていい。50字以下でも可。断言OK）
   ...
   例: 「ChatGPTに壁打ちさせると自分の思考の癖がモロに出る」

B. 実況・進捗（「今日〇〇した」「さっき〇〇した」形式）
   例: 「ChatGPTに構成だけ頼んで文章は自分で書いてみた　思ったより捗る」
...
E. 問い投げ（答えは出さない。疑問文で終わる）
   例: 「フォロワー数って結局どこから意味が出てくるんだろう」
   例: 「副業で月1万って最初に何を売るのが一番現実的なんだ？」

F. 意見・スタンス（小さくてもいいので立場を取る。断言系）
   例: 「AI時代に一番強いのはAIを使える人じゃなくて問いを立てられる人」
   例: 「副業は最初の3ヶ月、収益ゼロでも続けられるかが全て」

G. 雑談・日常（副業関係なくていい。人間っぽさを出す）
   例: 「平日の夜にこういうことやってるとなんか趣味みたいになってきた」
